...
//            else {
    ...
    private void SaveOrder(String axn) {
        ...
        AlertDialogBox.showDialog(VanSalesOrderActivity.this, "SFA", "Are You Sure Want to Submit?", "OK", "Cancel", false, new AlertBox() {
            @Override
                ...
                if (CategoryType == -1) {
                    ...
                    holder.ivDel.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            AlertDialogBox.showDialog(VanSalesOrderActivity.this, "SFA",
