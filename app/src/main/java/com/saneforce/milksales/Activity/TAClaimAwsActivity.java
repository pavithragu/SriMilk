                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if (txt_date.getText().toString().matches("")) {
                            ...
                            AlertDialogBox.showDialog(TAClaimAwsActivity.this, "Check-In", String.valueOf(Html.fromHtml("Do You submit your claim to Approval.")), "Yes", "No", false, new AlertBox() {
                                @Override
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        AlertDialogBox.showDialog(TAClaimAwsActivity.this, "Check-In", String.valueOf(Html.fromHtml("Do You Save your claim as Draft.")), "Yes", "No", false, new AlertBox() {
                            @Override
                            public void PositiveMethod(DialogInterface dialog, int id) {
                                dialog.dismiss();
                                if(clocation!=null){
...
/*
    ...
    public void submitData(String responseVal,CircularProgressButton btnAnim) {
        ...
        try {
            ...
            ResetSubmitBtn(0,btnAnim);
            AlertDialogBox.showDialog(TAClaimAwsActivity.this, "Check-In", String.valueOf(Html.fromHtml("Can't submit your claim. <br> "+e.getMessage())), "OK", "", false, new AlertBox() {
                @Override
                public void PositiveMethod(DialogInterface dialog, int id) {
                    dialog.dismiss();
                }
