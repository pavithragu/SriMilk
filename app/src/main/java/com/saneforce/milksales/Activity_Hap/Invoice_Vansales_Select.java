...
public class Invoice_Vansales_Select extends AppCompatActivity implements View.OnClickListener, UpdateResponseUI, Master_Interface {
    ...
    private void SaveOrder() {
        if (common_class.isNetworkAvailable(this)) {
            ...
            AlertDialogBox.showDialog(Invoice_Vansales_Select.this, "SFA", "Are You Sure Want to Submit?", "OK", "Cancel", false, new AlertBox() {
                @Override
                ...
                if (CategoryType == -1) {
                    holder.ivDel.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            AlertDialogBox.showDialog(Invoice_Vansales_Select.this, "SFA",
